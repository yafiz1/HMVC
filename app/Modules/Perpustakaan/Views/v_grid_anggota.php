        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="
                            <?= site_url("perpustakaan/anggota/edit/".$row['id_anggota']."/".$row['nama_anggota']."/".$row['jk_anggota']) ?>">Edit</a>
                        <a href="<?= site_url("perpustakaan/anggota/delete/".$row['id_anggota']);?>">| Delete</a>
                    </td>
                </tr>
                <?php $i++; } ?>
            </tbody>
