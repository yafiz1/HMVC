        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <?php if (session()->get('jabatan') == 'pustakawan'):?>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= site_url('Perpustakaan/anggota') ?>">Anggota</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= site_url('Perpustakaan/buku') ?>">Buku</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= site_url('Perpustakaan/peminjaman') ?>">Peminjaman</a></li>
                <?php elseif (session()->get('jabatan' == 'kepala')):?>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= site_url('Perpustakaan/petugas') ?>">Petugas</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </nav>
